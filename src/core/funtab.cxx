...
static const Function funtab[] =
{
   ...
   { "caar",                 []()->SEXPR{ return do_cxr("caar", 2); } , n_func },
   { "cadr",                 []()->SEXPR{ return do_cxr("cadr", 2); } , n_func },
   { "cdar",                 []()->SEXPR{ return do_cxr("cdar", 2); } , n_func },
   { "cddr",                 []()->SEXPR{ return do_cxr("cddr", 2); } , n_func },
   { "caaar",                []()->SEXPR{ return do_cxr("caaar", 3); } , n_func },
   { "caadr",                []()->SEXPR{ return do_cxr("caadr", 3); } , n_func },
   { "cadar",                []()->SEXPR{ return do_cxr("cadar", 3); } , n_func },
   { "caddr",                []()->SEXPR{ return do_cxr("caddr", 3); } , n_func },
   { "cdaar",                []()->SEXPR{ return do_cxr("cdaar", 3); } , n_func },
   { "cdadr",                []()->SEXPR{ return do_cxr("cdadr", 3); } , n_func },
   { "cddar",                []()->SEXPR{ return do_cxr("cddar", 3); } , n_func },
   { "cdddr",                []()->SEXPR{ return do_cxr("cdddr", 3); } , n_func },
   { "caaaar",               []()->SEXPR{ return do_cxr("caaaar", 4); } , n_func },
   { "caaadr",               []()->SEXPR{ return do_cxr("caaadr", 4); } , n_func },
   { "caadar",               []()->SEXPR{ return do_cxr("caadar", 4); } , n_func },
   { "caaddr",               []()->SEXPR{ return do_cxr("caaddr", 4); } , n_func },
   { "cadaar",               []()->SEXPR{ return do_cxr("cadaar", 4); } , n_func },
   { "cadadr",               []()->SEXPR{ return do_cxr("cadadr", 4); } , n_func },
   { "caddar",               []()->SEXPR{ return do_cxr("caddar", 4); } , n_func },
   { "cadddr",               []()->SEXPR{ return do_cxr("cadddr", 4); } , n_func },
   { "cdaaar",               []()->SEXPR{ return do_cxr("cdaaar", 4); } , n_func },
   { "cdaadr",               []()->SEXPR{ return do_cxr("cdaadr", 4); } , n_func },
   { "cdadar",               []()->SEXPR{ return do_cxr("cdadar", 4); } , n_func },
   { "cdaddr",               []()->SEXPR{ return do_cxr("cdaddr", 4); } , n_func },
   { "cddaar",               []()->SEXPR{ return do_cxr("cddaar", 4); } , n_func },
   { "cddadr",               []()->SEXPR{ return do_cxr("cddadr", 4); } , n_func },
   { "cdddar",               []()->SEXPR{ return do_cxr("cdddar", 4); } , n_func },
   { "cddddr",               []()->SEXPR{ return do_cxr("cddddr", 4); } , n_func },
   ...
   { "not",                   []()->SEXPR{ return test_predicate(notp); } , n_func },
   { "bound?",                []()->SEXPR{ return test_predicate(boundp); } , n_func },
   { "null?",                 []()->SEXPR{ return test_predicate(nullp); } , n_func },
   { "atom?",                 []()->SEXPR{ return test_predicate(atomp); } , n_func },
   { "list?",                 []()->SEXPR{ return test_predicate(listp); } , n_func },
   { "number?",               []()->SEXPR{ return test_predicate(numberp); } , n_func },
   { "boolean?",              []()->SEXPR{ return test_predicate(booleanp); } , n_func },
   { "pair?",                 []()->SEXPR{ return test_predicate(consp); } , n_func },
   { "symbol?",               []()->SEXPR{ return test_predicate(symbolp); } , n_func },
   { "complex?",              unimplemented , n_func },
   { "real?",                 []()->SEXPR{ return test_predicate(flonump); } , n_func },
   { "rational?",             unimplemented , n_func },
   { "integer?",              []()->SEXPR{ return test_predicate(fixnump); } , n_func },
   { "char?",                 []()->SEXPR{ return test_predicate(charp); } , n_func },
   { "string?",               []()->SEXPR{ return test_predicate(stringp); } , n_func },
   { "vector?",               []()->SEXPR{ return test_predicate(vectorp); } , n_func },
   { "byte-vector?",          []()->SEXPR{ return test_predicate(bvecp); } , n_func },
   { "closure?"  ,            []()->SEXPR{ return test_predicate(closurep); } , n_func },
   { "procedure?",            FUNC::procedurep , n_func },
   { "environment?",	      []()->SEXPR{ return test_predicate(envp); } , n_func },
   { "continuation?",	      []()->SEXPR{ return test_predicate(contp); } , n_func },
   { "port?",                 []()->SEXPR{ return test_predicate(portp); } , n_func },
   { "input-port?",           []()->SEXPR{ return test_predicate(inportp); } , n_func },
   { "output-port?",          []()->SEXPR{ return test_predicate(outportp); } , n_func },
   { "string-port?",          []()->SEXPR{ return test_predicate(stringportp); } , n_func },
   { "input-string-port?",    []()->SEXPR{ return test_predicate(instringportp); } , n_func },
   { "output-string-port?",   []()->SEXPR{ return test_predicate(outstringportp); } , n_func },
   { "object?",               unimplemented , n_func },
   { "eof-object?",           []()->SEXPR{ return test_predicate(eof_objectp); } , n_func },
   { "default-object?",       []()->SEXPR{ return test_predicate(default_objectp); } , n_func },
   { "zero?",                 []()->SEXPR{ return test_predicate(zerop); } , n_func },
   { "positive?",             []()->SEXPR{ return test_predicate(positivep); } , n_func },
   { "negative?",             []()->SEXPR{ return test_predicate(negativep); } , n_func },
   { "odd?",                  []()->SEXPR{ return test_predicate(oddp); } , n_func },
   { "even?",                 []()->SEXPR{ return test_predicate(evenp); } , n_func },
   { "exact?",                []()->SEXPR{ return test_predicate(exactp); } , n_func },
   { "inexact?",              []()->SEXPR{ return test_predicate(inexactp); } , n_func },
   { "promise?",              []()->SEXPR{ return test_predicate(promisep); } , n_func },
#ifdef BYTE_CODE_EVALUATOR
   { "code?",                 []()->SEXPR{ return test_predicate(codep); } , n_func },
#endif
   { "string-null?",          []()->SEXPR{ return test_predicate(string_nullp); } , n_func },
