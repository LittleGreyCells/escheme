...
static const Function funtab[] =
{
   ...
   { "caar",                 []{ return FUNC::cxr("aa", 1); } , n_func },
   { "cadr",                 []{ return FUNC::cxr("ad", 1); } , n_func },
   { "cdar",                 []{ return FUNC::cxr("da", 1); } , n_func },
   { "cddr",                 []{ return FUNC::cxr("dd", 1); } , n_func },
   { "caaar",                []{ return FUNC::cxr("aaa", 2); } , n_func },
   { "caadr",                []{ return FUNC::cxr("aad", 2); } , n_func },
   { "cadar",                []{ return FUNC::cxr("ada", 2); } , n_func },
   { "caddr",                []{ return FUNC::cxr("add", 2); } , n_func },
   { "cdaar",                []{ return FUNC::cxr("daa", 2); } , n_func },
   { "cdadr",                []{ return FUNC::cxr("dad", 2); } , n_func },
   { "cddar",                []{ return FUNC::cxr("dda", 2); } , n_func },
   { "cdddr",                []{ return FUNC::cxr("ddd", 2); } , n_func },
   { "caaaar",               []{ return FUNC::cxr("aaaa", 3); } , n_func },
   { "caaadr",               []{ return FUNC::cxr("aaad", 3); } , n_func },
   { "caadar",               []{ return FUNC::cxr("aada", 3); } , n_func },
   { "caaddr",               []{ return FUNC::cxr("aadd", 3); } , n_func },
   { "cadaar",               []{ return FUNC::cxr("adaa", 3); } , n_func },
   { "cadadr",               []{ return FUNC::cxr("adad", 3); } , n_func },
   { "caddar",               []{ return FUNC::cxr("adda", 3); } , n_func },
   { "cadddr",               []{ return FUNC::cxr("addd", 3); } , n_func },
   { "cdaaar",               []{ return FUNC::cxr("daaa", 3); } , n_func },
   { "cdaadr",               []{ return FUNC::cxr("daad", 3); } , n_func },
   { "cdadar",               []{ return FUNC::cxr("dada", 3); } , n_func },
   { "cdaddr",               []{ return FUNC::cxr("dadd", 3); } , n_func },
   { "cddaar",               []{ return FUNC::cxr("ddaa", 3); } , n_func },
   { "cddadr",               []{ return FUNC::cxr("ddad", 3); } , n_func },
   { "cdddar",               []{ return FUNC::cxr("ddda", 3); } , n_func },
   { "cddddr",               []{ return FUNC::cxr("dddd", 3); } , n_func },
