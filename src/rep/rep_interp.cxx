...
{   
   //
   // escheme and echeme-compiled
   //
   //   setup for these variants prepare for entry into eceval.
   //   nothing is pre-compiled and the sexprs defining the
   //   loader and path closure need to be read and evaluated
   //   prior to evaluating the rep loop symbolic expression.
   //
